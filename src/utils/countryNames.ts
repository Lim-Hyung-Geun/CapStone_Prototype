const numericToAlpha2: Record<string, string> = {
  ...
  "807": "MK", "818": "EG", "826": "GB", "834": "TZ", "840": "US", "850": "VI", "854": "BF", "858": "UY",
  "860": "UZ", "862": "VE", "876": "WF", "882": "WS", "887": "YE", "894": "ZM"
};

const regionNames = new Intl.DisplayNames(['ko'], { type: 'region' });

export const getKoreanCountryName = (id: string | number | undefined, englishName?: string): string => {
  if (id === undefined) return englishName || 'Unknown';
  ...
  if (alpha2) {
    try {
      return regionNames.of(alpha2) || englishName || String(id);
    } catch (e) {
      return englishName || String(id);
    }
  }
...
export const getKoreanRegionName = (englishName: string): string => {
  return subdivisionNames[englishName] || englishName;
};
